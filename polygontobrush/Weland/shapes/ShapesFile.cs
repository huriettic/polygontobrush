/*
 * This file is a modified version of ShapesFile.cs from Weland.
...
namespace Weland {
	...
	CollectionHeader[] collectionHeaders = Array.Empty<CollectionHeader>();
	Collection[] collections = Array.Empty<Collection>();
